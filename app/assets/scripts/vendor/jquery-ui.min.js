...
(function (t) {
        ...
        function () {
            ...
            t.expr && t.expr.filters && t.expr.filters.animated && (t.expr.filters.animated = function (e) {
                ...
                restore: function (t, e) {
                    for (var i, s = 0, o = e.length; o > s; s++) null !== e[s] && (i = t.data(n + e[s]), t.css(e[s], i))
                },
                ...
                effect: function () {
                    function i(e) {
                        function i() {
                            l.removeData(a), t.effects.cleanUp(l), "hide" === s.mode && l.hide(), r()
                        }
                        ...
                        var l = t(this);
                        s.mode = u.shift(), t.uiBackCompat === !1 || o ? "none" === s.mode ? (l[c](), r()) : n.call(l[0], s, i) : (l.is(":hidden") ? "hide" === c : "show" === c) ? (l[c](), r()) : n.call(l[0], s, r)
                    }
    ...
    var l;
    t.uiBackCompat !== !1 && (l = t.effects.define("transfer", function (e, i) {
        t(this).transfer(e, i)
    }))
});
